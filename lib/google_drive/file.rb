...
module GoogleDrive
  ...
  class File
    ...
    def download_to_file(path, params = {})
      @session.drive.get_file(id, {download_dest: path, supports_team_drives: true}.merge(params))
    end
    ...
    def download_to_io(io, params = {})
      @session.drive.get_file(id, {download_dest: io, supports_team_drives: true}.merge(params))
    end
